...
# Created by write_sdc on Tue Sep 30 11:36:27 2025
...
set_clock_groups -asynchronous -name UART_CLK_1 -group [list [get_clocks UART_CLK] [get_clocks RX_CLK] [get_clocks TX_CLK]] -group [list [get_clocks ALU_CLK] [get_clocks REF_CLK]] -group [get_clocks scan_clk]
